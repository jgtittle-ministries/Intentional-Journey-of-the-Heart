...
Volume 1 introduced these two main types. Structural Laws describe architecture, while Operational Laws explain causation and process. Both types appear in Volume 2, where an Exploration maps, extends, or applies a foundational law from Volume 1. When you see these tags in Volume 2, it indicates that the law is building directly on the Volume 1 framework rather than introducing something new.
